...
return [
    ...
    // Footer
    'footer_about_text' => 'Radimo na najsavremenijim mašinama, koje obezbeđuju visok kvalitet finalnog proizvoda.',
    ...
    'new_zip_bags' => 'Novo: Zip kese',
    'zip_bags_title' => 'Kese sa ZIP Zatvaračem:',
    'zip_bags_items' => [
        'Jedan Zip zatvarač',
        'Dupli Zip zatvarač',
        'Zip zatvarač sa Klizačem...',
    ],
    ...
    'products_list' => [
        ...
        'Tregerice',
        'OPS ambalaža',
        'Vazdušasta - Air Bubble folija...',
    ],
    'product_gallery_link' => 'Galerija proizvoda...',
    'learn_more_link' => 'Saznaj više...',
    'order_image_alt' => 'Kliknite da poručite proizvod',
    'prices_image_alt' => 'Pogledajte cene proizvoda',
    'recyclable_image_alt' => 'Proizvodi napravljeni od 100% recikliranih materijala',

    // products

    'proizvodi_naslov' => 'Proizvodnja i štampa reklamnih razgradivih polietilenskih kesa i džakova',
    ...
    'dzakovi' => 'Džakovi',
    'dzakovi_tekst' => 'Džakovi raznih veličina, debljina i dimenzija, za pakovanje raznih proizvoda. Džakovi za smeće. Džakovi za pakovanje specijalne namene. U mogućnosti smo da proizvedemo džakove prema vašim specifikacijama (dimenziji, debljini i boji).',

    'strec_folija' => 'Streč folije',
    'strec_folija_tekst' => 'Streč folija napravljena je da zadovolji najrazličitije potrebe, bilo da se radi o snazi, zaštiti, pouzdanosti ili ekonomičnosti. Danas je to najčešće korišćena folija za pakovanje proizvoda prilikom transporta. Osnovne karakteristike naše streč folije su veliko istezanje, visoka providnost, otpornost na oštećenja i ekonomska isplativost. Streč folija se prvenstveno koristi za obavijanje paleta, čime se sprečava padanje proizvoda, kao i finalni sloj zaštite oko osetljivog predmeta da bi se dobila kompaktnost prethodnih slojeva zaštite bilo da je to pucketava folija ili stiropor i sl. Ujedno ih štiteći od vlage i prljanja. Širina rolne: 50 cm. Dužina: min 300 m. Debljina: 25my. Težina: 5 kg.',

    'zip_kese' => 'Zip kese',
    'zip_kese_tekst' => 'Razne veličine zip kesa pogodnih za brzo pakovanje robe gde je potrebno više puta otvoriti ili zatvoriti istu kesu. Pored običnih ZIP kesa sa jednim zip zatvaračem (mono zip lock) počeli smo da proizvodimo i ZIP kese sa duplim zip zatvaračem (double zip lock) i zip kese sa patent zip zatvaračem (zip bags with Slider). Te kese su i vodonepropusne. Usvojili smo novu tehnologiju pa možemo da radimo i štampane zip kese i zip kese sa običnom rupom, euro rupom i banana ručkom kao što možete da vidite u galeriji slika zip kesa.',

    'treger_kese' => 'Treger kese',
    'treger_kese_tekst' => 'Treger kese koje proizvodimo su razgradive, a imaju širu primenu za jeftinije pakovanje i transport raznih artikala.',
    ...
    'about_naslov' => 'Više od proizvodnje – gradimo poverenje, iskustvo, kvalitet i održivost',

    'about_tekst1' => 'Preduzeće <strong>"Monoplast" d.o.o</strong> je osnovano 01.02.1994. godine, sa sedištem u Novoj Pazovi, ulica Pilota Zorana Latkovića broj 19. Prvobitna zanatska radnja <em>Grafiko</em> prerasta u Monoplast d.o.o., preduzeće specijalizovano za proizvodnju, štampu i prodaju polietilenske (P.E.) ambalaže - najlon kesa i džakova.',
    'about_tekst2' => '<strong>Radimo na najsavremenijim mašinama koje obezbeđuju visok kvalitet finalnog proizvoda.</strong> Kapaciteti proizvodnje su relativno veliki, što znači da će Vaša porudžbina biti obrađena brzo i efikasno – finalni proizvod, Vašu kesu, možete dobiti u najkraćem roku.',
    'about_tekst3' => '<strong>Proizvodnja kesa se vrši i po narudžbini, gde Vi birate debljinu, veličinu, boju i slično.</strong> Za veće tiraže, u mogućnosti smo da radimo i <strong>flexol štampu</strong> u jednoj ili više boja. U našem proizvodnom programu nalaze se i treger kese sa štampom.',
    'about_tekst4' => 'Pored same proizvodnje P.E. ambalaže, <strong>"Monoplast" d.o.o</strong> se bavi i proizvodnjom plastike široke potrošnje, kao i trgovinom, uvozom i izvozom.',
    'about_tekst5' => 'Ukoliko želite da na Vašim kesama odštampate zaštitni znak firme, reklamnu poruku ili možda sliku proizvoda - to možete učiniti u jednoj, dve, tri ili više boja. Naši grafičari će, po Vašem zahtevu, uraditi pripremu za štampu koristeći vrhunsku kompjutersku opremu i lasersko štampanje.',
    ...
    'about_prikazi_vise' => 'Prikaži više...',

    'about_sa_strane' => 'Zadovoljna mušterija, i visok kvalitet proizvoda, uz obavezno poštovanje rokova, naše su trajno opredeljenje. Biće nam drago, ukoliko nas izaberete za svog proizvođača P.E. ambalaže',
