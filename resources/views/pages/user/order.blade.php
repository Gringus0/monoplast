    ...
    <form action="{{ route('order.store') }}" method="POST" class="row wrapper nesto" enctype="multipart/form-data">
        ...
        <div class="col-12 col-md-6 col-xl-custom-4 orderBlocks" id="secondDiv">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <div class="kesa mt-4 kesa-boja banana_bez_ojacanja">
                        <div class="rucka"></div>
                    ...
                    <div class="kesa mt-4 kesa-boja bez_ojacanja_s_faltom">
                        <div class="rucka"></div>
                    ...
                    <div class="kesa mt-4 kesa-boja sa_ojacanom_banana">
                        <div class="okoRucke"></div>
                        <div class="rucka"></div>
                        <div class="dim-line vert">
                            <div class="dim-cap top"></div>
                    ...
                    <div class="kesa mt-4 kesa-boja sa_ojacanom_banana_s_faltom">
                        <div class="okoRucke"></div>
                        <div class="rucka"></div>
                        <div class="koseLinijeVelike"></div>
                        <div class="dim-line vert">
                    ...
                    <div class="kesa mt-4 kesa-boja fleksibilna">
                    ...
                    <div class="kesa mt-4 kesa-boja fleksibilna_s_faltom">
                        <div class="bag-handleVelika"></div>
                        <div class="koseLinijeVelike"></div>
                        <div class="dim-line vert">
                            <div class="dim-cap top"></div>
